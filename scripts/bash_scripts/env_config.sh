...
if [ "$QUICK_TEST" = false ]; then
  ...
  POP_TOTAL_TRAINING_TIMESTEPS=$((HOW_LONG * 5000000))
  N_X_SP_TOTAL_TRAINING_TIMESTEPS=$((HOW_LONG * 5000000))
  FCP_TOTAL_TRAINING_TIMESTEPS=$((HOW_LONG * 5000000))
  ADVERSARY_TOTAL_TRAINING_TIMESTEPS=$((HOW_LONG * 5000000))
  N_X_FCP_TOTAL_TRAINING_TIMESTEPS=$((2 * FCP_TOTAL_TRAINING_TIMESTEPS * HOW_LONG))
else
  WANDB_MODE="disabled"
  N_ENVS=200
  EPOCH_TIMESTEPS=2
