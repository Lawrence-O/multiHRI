...
HOW_LONG=5
NUM_OF_CKPOINTS=40
# Trimmed: 4 common layouts across 3-chef and 5-chef variants
LAYOUT_NAMES="2_on_3chefs_asymmetric_advantages,2_on_3chefs_coordination_ring,2_on_3chefs_counter_circuit,2_on_3chefs_cramped_room"
EXP_DIR="Complex/2_on_3_trimmed"
TOTAL_EGO_AGENTS=4
QUICK_TEST=false
...
for FCP_SEED in 1010 2020 2602 13; do
echo "=== Training FCP seed=$FCP_SEED ==="
